---
title: Paths & files
description: FHS layout reference for hal0 — every config file under /etc/hal0, every state path under /var/lib/hal0, the code and log roots, and how HAL0_HOME remaps them all.
sidebar:
  order: 70
---
