...
description: Update hal0 with a cosign-verified, atomic self-update — check the stable or nightly channel, apply or pin a version, and roll back to the previous tree if anything goes wrong.
sidebar:
  order: 110
---
