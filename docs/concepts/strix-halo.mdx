---
title: Strix Halo
description: hal0's reference hardware — AMD Ryzen AI Max+ with a Radeon iGPU, an XDNA NPU, and a large unified-memory pool — and why that shared GTT pool is the central tuning target.
sidebar:
  order: 40
---
